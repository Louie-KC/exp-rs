...
impl std::fmt::Display for ParseError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        let err_msg: String = match &self.kind {
            ...
            PEK::MissingIdentifier => "Function, parameter or variable name is not specified".into(),
            PEK::OutOfTokens => "Parser error: Parser exceeded the bounds of the token vector".into(),
        };
